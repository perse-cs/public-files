...
# 2. Name of a list/array used in the program:
# 3. Name of an integer variable used in the program:
# 4. Name of a real/float variable used in the program:
# 5. Name of a user-defined subprogram used in the program:
# 6. Line number of a selection construct:
# 7. Line number of a repetition construct:
# 8. Line number of an iteration construct:
