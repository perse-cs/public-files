...
# ------------------------------------------------------------------
# 1. Name of a constant used in the program: MAX_VISITS
# 2. Name of a one-dimensional array used in the program: studentNames
# 3. Name of a two-dimensional array used in the program: summaryTable
# 4. Name of a Boolean variable used in the program: bonusAwarded
# 5. Name of a real/float variable used in the program: averageVisits
# 6. Name of a user-defined function used in the program: calculate_status
# 7. Line number of a selection construct: 17
# 8. Line number of a repetition construct: 31
# 9. Line number of an iteration construct: 23
# 10. Line number of an instruction that outputs information to the screen: 37
